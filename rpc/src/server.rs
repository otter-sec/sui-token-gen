...
mod tests {
    ...
    async fn test_create_token_validation() {
        ...
        let result = server
            .clone()
            .create(ctx.clone(), 0, "Test".into(), "TST".into(), "Description".into(), false)
            .await;
        ...
        let result = server
            .clone()
            .create(ctx.clone(), 8, "Test".into(), "TSTST".into(), "Description".into(), false)
            .await;
        ...
        let result = server
            .clone()
            .create(ctx.clone(), 8, "Test".into(), "T$T".into(), "Description".into(), false)
            .await;
        assert!(matches!(result, Err(TokenGenErrors::InvalidSymbol)));
        ...
        let result = server
            .clone()
            .create(ctx.clone(), 8, "Test@".into(), "TST".into(), "Description".into(), false)
            .await;
        ...
        let result = server
            .clone()
            .create(ctx.clone(), 8, "Test".into(), "TST".into(), "Test@Description".into(), false)
            .await;
        assert!(matches!(result, Err(TokenGenErrors::InvalidDescription)));

        // Test valid input
        let result = server
            .create(ctx, 8, "Test Token".into(), "TST".into(), "Test Description".into(), false)
            .await;
        assert!(result.is_ok());
    }
