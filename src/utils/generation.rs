use crate::{errors::TokenGenErrors, utils::helpers::sanitize_name, variables::SUB_FOLDER, Result};
use std::fs;
...
pub fn create_move_toml(package_name: String, toml_content: String) -> Result<String> {
